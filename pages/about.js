...
import avatar from 'public/avatars.png';
    ...
    <Container title="About – Lee Robinson">
      <div className="flex flex-col justify-center items-start max-w-2xl mx-auto mb-16 w-full">
        ...
        <div className="mb-8 prose dark:prose-dark leading-6">
          ...
          <ul>
            <li>
              Twitter: <a href="https://twitter.com/muhdxsaiful">@muhdxsaiful</a>
            </li>
            <li>
              GitHub: <a href="https://github.com/MuhdSaifulnizam15">@MuhdSaifulnizam15</a>
            </li>
            <li>
              Website: <Link href="https://muhdsaiful.com">https://muhdsaiful.com</Link>
            </li>
            <li>
              LinkedIn:{' '}
          ...
          <h2>Bio</h2>
          <h3>Job Title</h3>
          <p>Muhd Saifulnizam, Software Developer at Rymnet Solutions</p>
          ...
          <h3>Education</h3>
          <p>
            Muhd Saiful graduated from Multimedia University with a B.S. in
